...
### Авто-определение шифта (по FFT пикам) — DONE (Build 200)
...
- [x] Кнопка SHIFT в нижней панели циклически: 85→170→...→850→AUTO→85
...
---
*Статус: В разработке (Ветка feat/alex-cl-dev, Build 202)*
