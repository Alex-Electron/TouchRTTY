...
<p align="center">
  <img src="images/screen_layout.svg" alt="Раскладка экрана TouchRTTY, 480×320 px" width="900">
</p>

Реальные высоты (из `src/ui/UIManager.hpp`): TOP BAR 34 px, полоса
частотных MARKER'ов 14 px, DSP-зона (водопад / спектр / scope) 64 px,
TEXT-зона 160 px (самая большая — половина экрана), BOTTOM BAR 48 px.
...
Здесь реально подкручиваешь DSP. Открывается из `MENU` → `TUNE`.
...
## Что реально показывает текст на экране
