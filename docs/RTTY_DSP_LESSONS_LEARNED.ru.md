# RTTY DSP — выводы из пройденных грабель

> 🇬🇧 [Read in English](RTTY_DSP_LESSONS_LEARNED.md)

Тут зафиксированы ключевые решения — математические, алгоритмические,
программные — которые позволили превратить RP2350 в профессиональный
DSP-модем уровня fldigi для RTTY.

Эти принципы — фундамент для будущих цифровых видов (CW, FT8 и т.д.)
