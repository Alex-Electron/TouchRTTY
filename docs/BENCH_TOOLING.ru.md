...
что мне надо было уверенно говорить «изменение помогло».
...
забытого тега у первого прогона раздражает.
...
странном состоянии. `STATUS` по serial покажет, что творится.
...
в неопределённом бакете — это единственная часть данных, что
