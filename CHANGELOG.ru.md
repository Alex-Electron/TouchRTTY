...
Существенно переписанный код относительно v1.72. Полные release notes —
...
* **Обгоняет 2Tone 26.01a на низком SNR** в 3–6 раз по реальному error
  ...
  SNR −4..−22 dB.
* **Production-веса NN (v13)** идут с прошивкой: PyTorch-натренированный
...
* **Документы** в `docs/` про подключение железа,
...
* **NOTCH / VIT** перенесены из поупапа в inline-тоглы меню — меньше
  тапов.
